...
impl ParsedPacket {
    ...
    pub fn parse_packet(&self, data: Vec<u8>, len:u32, ts:String) -> Result<ParsedPacket, String> {
    ...
    pub fn parse_ipv4(&self, content: &[u8], parsed_packet: &mut ParsedPacket) -> Result<(), String> {
    ...
    pub fn parse_ipv6(&self, content: &[u8], parsed_packet: &mut ParsedPacket) -> Result<(), String> {
    ...
    pub fn parse_tcp(&self, content: &[u8], parsed_packet: &mut ParsedPacket) -> Result<(), String> {
    ...
    pub fn parse_udp(&self, content: &[u8], parsed_packet: &mut ParsedPacket) -> Result<(), String> {
